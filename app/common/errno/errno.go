...
import (
	"fmt"
	"go-ssip/app/common/kitex_gen/errno"
)
...
var (
	...
	RPCMsgSrvErr       = NewErrNo(int64(errno.Err_RPCMsgSrvErr), "rpc msg service error")
	MsgSrvErr          = NewErrNo(int64(errno.Err_MsgSrvErr), "msg service error")
	RPCGroupSrvErr     = NewErrNo(int64(errno.Err_RPCGroupSrvErr), "rpc group service error")
	GroupSrvErr        = NewErrNo(int64(errno.Err_GroupSrvErr), "group service error")
