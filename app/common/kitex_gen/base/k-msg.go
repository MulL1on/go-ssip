...
func (p *Msg) FastReadField8(buf []byte) (int, error) {
	offset := 0
...
func (p *Msg) fastWriteField8(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "client_id", thrift.I64, 8)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.ClientId)
...
func (p *Msg) field8Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("client_id", thrift.I64, 8)
	l += bthrift.Binary.I64Length(p.ClientId)
