...
type Msg struct {
	...
	ClientId int64  `thrift:"client_id,8" frugal:"8,default,i64" json:"client_id"`
}
...
func (p *Msg) GetClientId() (v int64) {
	return p.ClientId
}
...
func (p *Msg) SetClientId(val int64) {
	p.ClientId = val
}
...
func (p *Msg) ReadField8(iprot thrift.TProtocol) error {
...
func (p *Msg) writeField8(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("client_id", thrift.I64, 8); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.ClientId); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *Msg) DeepEqual(ano *Msg) bool {
	...
	if !p.Field8DeepEqual(ano.ClientId) {
		return false
	}
	return true
}
...
func (p *Msg) Field8DeepEqual(src int64) bool {
