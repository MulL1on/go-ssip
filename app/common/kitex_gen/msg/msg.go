...
type SendMsgReq struct {
	Msg *base.Msg `thrift:"msg,1" frugal:"1,default,base.Msg" json:"msg"`
}
...
var SendMsgReq_Msg_DEFAULT *base.Msg

func (p *SendMsgReq) GetMsg() (v *base.Msg) {
	if !p.IsSetMsg() {
		return SendMsgReq_Msg_DEFAULT
	}
	return p.Msg
}
func (p *SendMsgReq) SetMsg(val *base.Msg) {
	p.Msg = val
}
...
func (p *SendMsgReq) Field1DeepEqual(src *base.Msg) bool {
...
func (p *GetMsgReq) GetUserId() (v int64) {
	return p.UserId
}
...
func (p *GetMsgReq) SetUserId(val int64) {
	p.UserId = val
}
